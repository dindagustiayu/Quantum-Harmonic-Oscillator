{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "25f49bae-b472-463d-b6ea-16af8e4175a3",
   "metadata": {},
   "source": [
    " ---\n",
    "title: \"Integral in Quantum Harmonic Oscillator\"\n",
    "date: \"2026-3-27\"\n",
  ...
  {
   "cell_type": "markdown",
   "id": "6a5a0f70-d513-4644-a902-9f23acb6e817",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "97acfdfd-dddd-4d1c-853b-5ccbee96a110",
   "metadata": {},
   "source": [
    ...
    "\n",
    "In order to solve this problem quantum mechanically, we follow our standard steps. The schr$\\ddot{o}$inger equation of the harmonic oscillator is given by\n",
    "\n",
    "<p align='center'>\n",
    ...
    "\n",
    "\n",
    "This Python script to illustrate the one-dimensional harmonic oscillator ground state wacefunction with following parameters:"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "0f43cf6d-f89e-49b6-9939-810b6d7de221",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "0ba6cba3-7f5e-4aa3-97c7-d4868209095f",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "06a79ded-cae6-4547-a91f-c8d3bb57c1b4",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "9a5a43ed-e1bf-4c9a-b45c-0f15737745df",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "3eab41ca-e96e-4e00-8965-36c74d047b40",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "522a859a-f658-469d-8bac-52fd82c1c54c",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "8dfe4d8c-9b34-4546-be6f-a4438f612fbe",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "55beeb43-5309-4d0e-9465-85edcb9ec258",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "07df838b-6fb4-4baf-b8f4-c18b434675c3",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "cb92f3c8-e3c8-45ad-912b-3b9b368e11e3",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "9126a281-4dcd-4cf1-a52a-73413855552b",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "id": "aa9327b8-c35c-456c-be7b-bea3ab50ce5f",
   "metadata": {},
   "outputs": [],
   "source": []
  }
